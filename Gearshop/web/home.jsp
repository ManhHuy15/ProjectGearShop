                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action="productList">
                        <div class="navbar-nav me-auto mb-2 mb-lg-1">
                            <div><input name="name" class="form-control my-2 my-sm-2 nav-item" style="width: 500px" type="search" placeholder="Search" aria-label="Search"></div>
                            <div><button class="btn btn-outline-success my-2 my-sm-2 nav-item" type="submit">Search</button></div>                          
                        </div>
                    </form>
                    <!-- Left links -->
                </div>
